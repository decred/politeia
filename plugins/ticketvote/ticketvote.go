...
// TODO StartDetails, StartReply, StartRunoffReply should contain a receipt.
...
// StartDetails is the structure that is saved to disk when a vote is started.
...
type DetailsReply struct {
	...
	StartDetails *StartDetails      `json:"startdetails"`
}
