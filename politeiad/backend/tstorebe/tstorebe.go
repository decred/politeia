...
type tstoreBackend struct {
	...
	dataDir  string
	shutdown bool
	unvetted *tstore.Tstore
	vetted   *tstore.Tstore
...
func (t *tstoreBackend) fullLengthToken(prefix []byte) ([]byte, bool) {
	t.Lock()
	defer t.Unlock()
...
//
// This function must be called WITHOUT the lock held.
func (t *tstoreBackend) unvettedTreeIDFromToken(token []byte) int64 {
...
func (t *tstoreBackend) vettedTreeID(token []byte) (int64, bool) {
	t.RLock()
	defer t.RUnlock()
...
func (t *tstoreBackend) vettedTreeIDAdd(token string, treeID int64) {
	t.Lock()
	defer t.Unlock()
...
//
// This function must be called WITHOUT the lock held.
func (t *tstoreBackend) vettedTreeIDFromToken(token []byte) (int64, bool) {
...
var (
	...
	// change is allowed.
	//
	// Note, the tstore backend does not make use of the status
	// MDStatusIterationUnvetted. The original purpose of this status
	// was to show when an unvetted record had been altered since
	// unvetted records were not versioned in the git backend. The tstore
...
func (t *tstoreBackend) New(metadata []backend.MetadataStream, files []backend.File) (*backend.RecordMetadata, error) {
	log.Tracef("New")
...
// This function satisfies the Backend interface.
func (t *tstoreBackend) UpdateUnvettedRecord(token []byte, mdAppend, mdOverwrite []backend.MetadataStream, filesAdd []backend.File, filesDel []string) (*backend.Record, error) {
...
// This function satisfies the Backend interface.
func (t *tstoreBackend) UpdateVettedRecord(token []byte, mdAppend, mdOverwrite []backend.MetadataStream, filesAdd []backend.File, filesDel []string) (*backend.Record, error) {
...
// This function satisfies the Backend interface.
func (t *tstoreBackend) UpdateUnvettedMetadata(token []byte, mdAppend, mdOverwrite []backend.MetadataStream) error {
	// Validate record contents. Send in a single metadata array to
	// verify there are no dups.
	allMD := append(mdAppend, mdOverwrite...)
...
// This function satisfies the Backend interface.
func (t *tstoreBackend) UpdateVettedMetadata(token []byte, mdAppend, mdOverwrite []backend.MetadataStream) error {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) UnvettedExists(token []byte) bool {
...
// This function satisfies the Backend interface.
func (t *tstoreBackend) VettedExists(token []byte) bool {
...
func (t *tstoreBackend) unvettedPublish(token []byte, rm backend.RecordMetadata, metadata []backend.MetadataStream, files []backend.File) (int64, error) {
	...
	// Save the record to the vetted tstore
...
// This function must be called WITH the record lock held.
func (t *tstoreBackend) unvettedCensor(token []byte, rm backend.RecordMetadata, metadata []backend.MetadataStream) error {
	// Freeze the tree
	treeID := treeIDFromToken(token)
...
func (t *tstoreBackend) SetUnvettedStatus(token []byte, status backend.MDStatusT, mdAppend, mdOverwrite []backend.MetadataStream) (*backend.Record, error) {
...
// This function must be called WITH the record lock held.
func (t *tstoreBackend) vettedCensor(token []byte, rm backend.RecordMetadata, metadata []backend.MetadataStream) error {
	// Freeze the tree
...
// This function must be called WITH the record lock held.
func (t *tstoreBackend) vettedArchive(token []byte, rm backend.RecordMetadata, metadata []backend.MetadataStream) error {
...
// This function satisfies the Backend interface.
func (t *tstoreBackend) SetVettedStatus(token []byte, status backend.MDStatusT, mdAppend, mdOverwrite []backend.MetadataStream) (*backend.Record, error) {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) GetUnvettedBatch(reqs []backend.RecordRequest) (map[string]backend.Record, error) {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) GetVettedBatch(reqs []backend.RecordRequest) (map[string]backend.Record, error) {
...
// This function satisfies the Backend interface.
func (t *tstoreBackend) GetUnvettedTimestamps(token []byte, version string) (*backend.RecordTimestamps, error) {
...
// This function satisfies the Backend interface.
func (t *tstoreBackend) GetVettedTimestamps(token []byte, version string) (*backend.RecordTimestamps, error) {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) InventoryByStatus(state string, status backend.MDStatusT, pageSize, page uint32) (*backend.InventoryByStatus, error) {
...
// RegisterUnvettedPlugin registers a plugin with the unvetted tstore instance.
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) RegisterUnvettedPlugin(p backend.Plugin) error {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) RegisterVettedPlugin(p backend.Plugin) error {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) SetupUnvettedPlugin(pluginID string) error {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) SetupVettedPlugin(pluginID string) error {
...
func (t *tstoreBackend) unvettedPluginRead(token []byte, pluginID, cmd, payload string) (string, error) {
...
func (t *tstoreBackend) unvettedPluginWrite(token []byte, pluginID, cmd, payload string) (string, error) {
	// Get tree ID
	treeID := t.unvettedTreeIDFromToken(token)
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) UnvettedPluginCmd(action string, token []byte, pluginID, cmd, payload string) (string, error) {
...
func (t *tstoreBackend) vettedPluginRead(token []byte, pluginID, cmd, payload string) (string, error) {
	// The token is optional. If a token is not provided then a tree ID
	// will not be provided to the plugin.
	var treeID int64
	var ok bool
...
func (t *tstoreBackend) vettedPluginWrite(token []byte, pluginID, cmd, payload string) (string, error) {
	// Get tree ID
	treeID, ok := t.vettedTreeIDFromToken(token)
	if !ok {
		return "", backend.ErrRecordNotFound
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) VettedPluginCmd(action string, token []byte, pluginID, cmd, payload string) (string, error) {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) GetUnvettedPlugins() []backend.Plugin {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) GetVettedPlugins() []backend.Plugin {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) GetPlugins() ([]backend.Plugin, error) {
...
//
// This function satisfies the Backend interface.
func (t *tstoreBackend) Plugin(pluginID, cmd, cmdID, payload string) (string, error) {
...
// setup creates the tstore backend caches.
