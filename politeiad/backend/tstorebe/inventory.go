...
func (t *tstoreBackend) invAdd(state string, token []byte, s backend.MDStatusT) error {
	t.Lock()
	defer t.Unlock()
...
func (t *tstoreBackend) invUpdate(state string, token []byte, s backend.MDStatusT) error {
	t.Lock()
	defer t.Unlock()
...
// inventory.
func (t *tstoreBackend) invMoveToVetted(token []byte, s backend.MDStatusT) error {
	t.Lock()
	defer t.Unlock()
...
func (t *tstoreBackend) inventoryAdd(state string, token []byte, s backend.MDStatusT) {
...
func (t *tstoreBackend) inventoryUpdate(state string, token []byte, s backend.MDStatusT) {
...
// just panic.
func (t *tstoreBackend) inventoryMoveToVetted(token []byte, s backend.MDStatusT) {
...
func (t *tstoreBackend) invByStatus(state string, s backend.MDStatusT, pageSize, page uint32) (*invByStatus, error) {
