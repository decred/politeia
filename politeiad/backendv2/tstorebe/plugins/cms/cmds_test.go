...
func TestProposalStatus(t *testing.T) {
	...
	var tests = []struct {
		...
		proposalStatus cms.PropStatusT // Expected proposal status
	}{
		{
			"unvetted",
		...
		},
		{
			...
			ticketvote.VoteStatusInvalid,
			nil,
			cms.PropStatusUnvettedCensored,
		},
		{
			"unvetted-abandoned",
			backend.StateUnvetted,
			...
			ticketvote.VoteStatusInvalid,
			nil,
			cms.PropStatusUnvettedAbandoned,
		},
		{
			"abandoned",
			backend.StateVetted,
		...
		},
		{
			...
			&cms.InvoiceStatusChange{
				Status: cms.InvoiceStatusClosed,
			},
			cms.PropStatusClosed,
		},
		{
			"completed",
			backend.StateVetted,
			...
			ticketvote.VoteStatusApproved,
			&cms.InvoiceStatusChange{
				Status: cms.InvoiceStatusCompleted,
			},
			cms.PropStatusCompleted,
		},
		{
			"invalid",
			backend.StateUnvetted,
