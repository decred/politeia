...
Update a record:
```
$ politeia -v -testnet -rpchost 127.0.0.1 -rpcuser=user -rpcpass=pass update 'appendmetadata12:{"foo":"bar"}' 'overwritemetadata2:{"12foo":"12bar"}' del:a add:b token:72fe14a914783eafb78adcbcd405e723c3f55ff475043b0d89b2cf71ffc6a2d4
