...
const (
	...
	ErrorStatusMaxIndexFilesExceeded       ErrorStatusT = 9
	ErrorStatusMaxIndexFileSizeExceeded    ErrorStatusT = 10
	ErrorStatusMaxAttachmentsExceeded      ErrorStatusT = 11
	ErrorStatusMaxAttachmentSizeExceeded   ErrorStatusT = 12
...
var (
	...
	ErrorStatus = map[ErrorStatusT]string{
		...
		ErrorStatusMaxIndexFilesExceeded:       "maximum index files exceeded",
		ErrorStatusMaxIndexFileSizeExceeded:    "maximum index file size exceeded",
		ErrorStatusMaxAttachmentsExceeded:      "maximum file attachments exceeded",
		ErrorStatusMaxAttachmentSizeExceeded:   "maximum attachment file size exceeded",
