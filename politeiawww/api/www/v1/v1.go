...
const (
	...
	RouteProposalDetails          = "/proposals/{token:[A-z0-9]+}"
	RouteSetProposalStatus        = "/proposals/{token:[A-z0-9]+}/status"
	RouteCommentsGet              = "/proposals/{token:[A-z0-9]+}/comments"
	RouteVoteResults              = "/proposals/{token:[A-z0-9]+}/votes"
	RouteVoteStatus               = "/proposals/{token:[A-z0-9]+}/votestatus"
