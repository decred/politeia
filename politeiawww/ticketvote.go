...
func (p *politeiawww) voteTimestamps(ctx context.Context, t ticketvote.Timestamps) (*ticketvote.TimestampsReply, error) {
...
func (p *politeiawww) processTicketVoteTimestamps(ctx context.Context, t tkv1.Timestamps) (*tkv1.TimestampsReply, error) {
	...
	// Send plugin command
	r, err := p.voteTimestamps(ctx, ticketvote.Timestamps{
		Token: t.Token,
	})
	if err != nil {
		return nil, err
