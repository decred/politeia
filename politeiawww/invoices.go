...
// checkCMSPayments makes sure that any payment that is currently stored in
// the cmsdb has an associated record metadata entry.
func (p *politeiawww) checkCMSPayments() error {
