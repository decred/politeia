...
const (
	defaultConfigFilename = "politeiavoteraudit.conf"
	defaultLogLevel       = "info"
	defaultLogDirname     = "logs"
	defaultLogFilename    = "politeiavoteraudit.log"
	defaultPiVoteDirname  = "vote"
)

var (
	defaultHomeDir    = dcrutil.AppDataDir("politeiavoteraudit", false)
	defaultConfigFile = filepath.Join(defaultHomeDir, defaultConfigFilename)
	defaultLogDir     = filepath.Join(defaultHomeDir, defaultLogDirname)

	defaultPiDir     = dcrutil.AppDataDir("politeiavoter", false)
	defaultPiVoteDir = filepath.Join(defaultPiDir, defaultPiVoteDirname)
)
...
type config struct {
	...
	PiDir       string `long:"politeiavoter" description:"Path to politeiavoter home directory"`
	Verbose     bool   `long:"verbose" description:"Print more stuff"`
...
func loadConfig() (*config, []string, error) {
	...
	if preCfg.HomeDir != "" {
		...
		if preCfg.voteDir == defaultPiVoteDir {
			cfg.voteDir = filepath.Join(cfg.PiDir, defaultPiVoteDirname)
		} else {
